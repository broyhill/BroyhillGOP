#!/usr/bin/env python3
"""
BROYHILLGOP MASS PAGE UPDATER
Updates ALL ecosystem pages with 7-hemisphere navigation
Run: python3 build_all_pages.py
"""
...
# The new sidenav content to inject
NEW_SIDENAV = '''<!-- Sidenav Menu Start -->
        <div class="sidenav-menu">

            <!-- BroyhillGOP AI Logo - Campaign Composer Wizard -->
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#navData" aria-expanded="false" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-database"></i></span>
                        <span class="menu-text">Data</span>
                        <span class="badge bg-primary">130K+</span>
                    </a>
                    <div class="collapse" id="navData">
                        <ul class="sub-menu">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#navDonors" aria-expanded="false" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-cash"></i></span>
                        <span class="menu-text">Fundraising</span>
                    </a>
                    <div class="collapse" id="navDonors">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item"><a href="ecosystem-39-p2p-fundraising.html" class="side-nav-link"><span class="menu-text">E39 P2P</span></a></li>
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#navVol" aria-expanded="false" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-users-group"></i></span>
                        <span class="menu-text">Activists</span>
                    </a>
                    <div class="collapse" id="navVol">
                        <ul class="sub-menu">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#navComms" aria-expanded="false" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-message-circle"></i></span>
                        <span class="menu-text">Channels</span>
                    </a>
                    <div class="collapse" id="navComms">
                        <ul class="sub-menu">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#navMedia" aria-expanded="false" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-video"></i></span>
                        <span class="menu-text">Production</span>
                    </a>
                    <div class="collapse" id="navMedia">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item"><a href="ecosystem-14-print-production.html" class="side-nav-link"><span class="menu-text">E14 Print</span></a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#navOps" aria-expanded="false" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-settings"></i></span>
                        <span class="menu-text">Management</span>
                    </a>
                    <div class="collapse" id="navOps">
                        <ul class="sub-menu">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#navWiz" aria-expanded="false" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-wand"></i></span>
                        <span class="menu-text">Compose</span>
                        <span class="badge bg-success">NEW</span>
                    </a>
                    <div class="collapse" id="navWiz">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item"><a href="direct-mail-wizard.html" class="side-nav-link"><span class="menu-text">📬 Mail</span></a></li>
                        </ul>
                    </div>
                </li>
...
def update_file(filepath):
    ...
    try:
        ...
        if 'sidenav-menu' not in content:
            return False, "No sidenav"
        
        # Find and replace the entire sidenav section
        pattern = r'<!-- Sidenav Menu Start -->.*?<!-- Sidenav Menu End -->'
        
        if re.search(pattern, content, re.DOTALL):
            new_content = re.sub(pattern, NEW_SIDENAV, content, flags=re.DOTALL)
            with open(filepath, 'w', encoding='utf-8') as f:
                f.write(new_content)
            return True, "Updated"
        else:
            # Try alternate pattern
            pattern2 = r'<div class="sidenav-menu">.*?</div>\s*<!-- Sidenav Menu End -->'
            if re.search(pattern2, content, re.DOTALL):
                # Insert before the closing
                new_content = re.sub(pattern2, NEW_SIDENAV, content, flags=re.DOTALL)
                with open(filepath, 'w', encoding='utf-8') as f:
                    f.write(new_content)
                return True, "Updated (alt)"
...
def main():
    ...
    for filename in os.listdir(BASE_DIR):
        if filename.endswith('.html'):
            # Include ecosystem files, wizards, main pages
            if any(x in filename for x in ['ecosystem-', 'wizard', 'donors', 'volunteers', 'jeff-zenger', 'candidates', 'settings', 'data-upload']):
                target_files.append(filename)
    
    target_files.sort()
    
    print(f"=" * 60)
    print(f"BROYHILLGOP MASS PAGE UPDATER")
    print(f"=" * 60)
