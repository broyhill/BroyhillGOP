...
## BroyhillGOP Platform — Authoritative Reference for Every Claude Session

**⚠️ READ THIS ENTIRE FILE BEFORE TOUCHING ANYTHING ⚠️**

Last updated: April 13, 2026 (Claude Sonnet 4.6, Cowork session)
Maintained by: Claude + Perplexity jointly. Update at end of every session.

---

## WHY THIS FILE EXISTS

Previous Claude sessions caused database damage by:
...
**Rule 0: Read this file. Read SESSION-STATE.md. Then ask what today's task is. Do not design, create, migrate, or ALTER anything until you understand the current state.**
...
## §5 IMMUTABLE ARCHITECTURAL RULES
...
Before any migration, bulk data change, or ecosystem restructure:
...
## §9 WHAT TO SAY TO EDDIE AT START OF SESSION

After reading this file and SESSION-STATE.md, open with:

> "I've read the master context and session state. Current architecture is on Hetzner PG16 (not Supabase). Brain worker is still the critical gap. [State what's in progress from SESSION-STATE]. What are we working on today?"

Do NOT start designing or proposing until you know today's specific task.
Do NOT assume a table exists — check SESSION-STATE.md or ask Perplexity to confirm.
Do NOT write SQL that touches donor_intelligence or brain schema without Rule 14 backup first.
...
*Last updated by: Claude Sonnet 4.6 — April 13, 2026*
