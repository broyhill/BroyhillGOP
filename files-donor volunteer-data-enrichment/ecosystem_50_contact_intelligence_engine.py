...
# ============================================================================
# SOCIAL MEDIA AI AGENT INTEGRATION (E19 + E44)
# ============================================================================
...
async def main():
    ...
    parser.add_argument('--job', choices=[
        ...
        'deceased_check',
        'listen_prospects',      # NEW: Listen for E44 prospects
        'listen_engagers',       # NEW: Listen for E19 engagements
        'rnc_sync',
        'monthly_enrich',
        'quarterly_enrich'
    ], help='Job to run')
    parser.add_argument('--donor-id', help='Donor ID for single enrichment')
    ...
    if args.job == 'enrich_donor' and args.donor_id:
        ...
        # Default: Run deceased check
        result = await engine.run_deceased_check(max_donors=100)
        print(json.dumps(result, indent=2, default=str))
